...
#' 
#' This function allows to use a custom thresholding method to maximize the Sensitivity (True Positive Rate).
#' 
...
#' 
#' @return A one or two element vector containing the maximum Sensitivity (True Positive Rate) for binary data, and the threshold used if requested. Returns \code{-1} in case of errors.
#' 
#' @export

metrics.sensitivity.max <- function(preds, labels, threshold = FALSE) {

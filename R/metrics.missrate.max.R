...
#' 
#' @return A one or two element vector containing the minimum Miss-Rate (False Negative Rate) for binary data, and the threshold used if requested. Returns \code{-1} in case of errors.
#' 
#' @export

metrics.missrate.max <- function(preds, labels, threshold = FALSE) {
